        ...
        <div class="sidebar">
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column">
                    <li class="nav-item"><a href="/commerce/e-commerce-main/admin-dashboard.php" class="nav-link"><i class="nav-icon fas fa-tachometer-alt"></i> <p>Dashboard</p></a></li>
                    <li class="nav-item"><a href="/e-commerce-main/orders_management.php" class="nav-link"><i class="nav-icon fas fa-shopping-cart"></i> <p>Manage Orders</p></a></li>
